...
#### events
Поле | Тип | Описание
id | BIGINT | Первичный ключ, автоинкримент
timestamp_event | TIMESTAMPZ | Время события с часовым поясом
...
#### ab_exposures
user_id | BIGINT | Идентификатор пользователя
timestamp_ab | TIMESTAMPZ | Время A/B-теста с часовым поясом
