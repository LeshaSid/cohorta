...
## Результаты
- **А/В-тест**: конверсия в группе B на 2.12% больше.
- **LTV**: накопленная выручка на пользователя растёт с каждым периодом.
- **Удержание**: на второй день резко падает до 0.4-3% в зависимости от когорты.
