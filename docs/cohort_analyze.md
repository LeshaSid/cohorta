# Резюме
Удержание сильно падает на 2-й день(до 0.4-3% в зависимости от когорты), скорее всего, пользователи приходят за разовым действием, какой-то специфической покупкой и не задерживаются надолго.
